...
if (!class_exists("sp_catMyComponent")) {
    ...
    class sp_catMyComponent extends sp_catComponent{
        ...
        static function enqueueJS(){
            wp_register_script( 'sp_catMyComponentJS', plugins_url('/js/sp_catMyComponent.js', __FILE__));
            //wp_enqueue_script( 'sp_catMyComponentJS', array('jquery', 'sp_admin_globals', 'sp_admin_js', 'sp_catComponentJS') );
        }
